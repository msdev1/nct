...
<div class="panel">
  ...
  <div class="panel-body">
    <center>
      <i class="fa fa-hand-paper-o icon-size text-warning" aria-hidden="true"><br>ERROR 405</i><br>
      <h1  class="text-danger" ><i class="fa fa-ban" aria-hidden="true"></i> Acess Denied <i class="fa fa-ban" aria-hidden="true"></i></h1></center>
  </div>
