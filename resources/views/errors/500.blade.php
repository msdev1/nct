...
<div class="panel">
  ...
  <div class="panel-body">
    <center>
      <i class="fa fa-server icon-size text-warning" aria-hidden="true"><br>ERROR 500</i><br>
      <h1  class="text-danger" ><i class="fa fa-chain-broken" aria-hidden="true"></i> Server Error <i class="fa fa-chain-broken" aria-hidden="true"></i></h1></center>
  </div>
