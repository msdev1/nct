...
<div class="panel">
  ...
  <div class="panel-body">
    <center>
      <i class="fa fa-exclamation-circle icon-size text-warning" aria-hidden="true"><br>ERROR 404</i><br>
      <h1 class="text-danger"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Sorry,Page Not Found <i class="fa fa-exclamation-triangle" aria-hidden="true"></i></h1></center>
  </div>
